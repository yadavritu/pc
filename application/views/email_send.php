	...
	<body>
		...
		<div class="auth-wrapper">
			<div class="auth-header">
							<div class="auth-title">Pizza</div>
				<div class="auth-subtitle">Simple and Clean Pizza  Admin Template</div>
			...
			<div class="auth-body">
				<div class="auth-content">
					...
					<div class="form-group">
						...
						<label>Email</label>
						<input class="form-control" placeholder="Enter email"  type="email" name="temail">
					</div>
