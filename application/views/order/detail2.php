...
<!-- Mirrored from demo.designshopify.com/html_fastfood/order.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Feb 2018 11:43:36 GMT -->
...
<head>
	...
	<link href="<?= base_url(); ?>assets_client/maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all">
								...
								<div class="breadcrumb-group">
									...
									<div class="breadcrumb clearfix">
										...
										<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
											<a href="order.html" title="Order History" itemprop="url"><span itemprop="title">Order History</span></a>
										</span>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="order-inner">
								<div class="order-content">
									<div class="order-id">
										<h2>Order #1002</h2>
										<span class="date">14 Nov 06:42</span>
										...
										<div id="order_payment" class="col-md-6 address-items">
											...
											<div class="address-content">
												<div class="address-item">
													...
													<span class="content">Voided</span>
												</div>
												<div class="address-item name">
													<span class="title">Your name:</span>
													<span class="content">Jin Alkaid</span>
												</div>
												<div class="address-item">
												...
												<div class="address-item">
													...
													<span class="content">Ho Chi Minh</span>
												</div>
												<div class="address-item">
													<span class="title">Zip / Postal Code:</span>
													<span class="content">700000</span>
												</div>
											</div>
										</div>
										...
										<div id="order_shipping" class="col-md-6 address-items">
											...
											<div class="address-content">
												<div class="address-item">
													...
													<span class="content">Unfulfilled</span>
												</div>
												<div class="address-item name">
													<span class="title">Your name:</span>
													<span class="content">Jin Alkaid</span>
											...
											<table id="order_details">
												...
												<tfoot>
													...
													<tr class="order_summary note">
														...
														<td class="shipping"><span class="money" data-currency-usd="$10.00" data-currency="USD">$10.00</span></td>
													</tr>
													<tr class="order_summary note">
